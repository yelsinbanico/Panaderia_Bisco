...
function sumarCantidad(event){
    ...
    var cantidadActual = selector.getElementsByClassName('carrito-items-cantidad')[0].value;
    console.log(cantidadActual);
    cantidadActual++;
    selector.getElementsByClassName('carrito-items-cantidad')[0].value=cantidadActual;
...
/*function actualizarTotalCarrito(){
    ...
    for (var i =0; i<carritoItems.length;i++){
        ...
        var precioProductoTexto=item.getElementsByClassName('carrito-item-precio')[0];
